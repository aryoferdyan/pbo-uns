...
public class Member {
    ...
    ArrayList<DaftarMember> Member = new ArrayList<DaftarMember>();
    public DaftarMember member;
    ...
    public void addMember(DaftarMember data) {
    ...
    public DaftarMember inputMember() {
